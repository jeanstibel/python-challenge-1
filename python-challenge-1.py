...
while place_order:
    ...
    menu_category = input("Type the menu order: ")
    ...
    if menu_category.isdigit():
        ...
        if int(menu_category) in menu_items.keys():
            ...
            menu_item = input("Type the menu item number: ")
    ...
    while True:
        ...
        # 5. Check the customer's input (use match for it)
        match keep_ordering.lower():
            ...
            case _:
                # Tell the customer their input is invalid
...
for item in order:
    ...
    num_item_spaces = 24 - len(item['Item name']) +1
    num_price_spaces = 4 - len(str(item['Price']))
